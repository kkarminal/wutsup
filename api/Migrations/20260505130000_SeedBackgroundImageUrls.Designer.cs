...
namespace Wutsup.Api.Migrations
{
    ...
    [Migration("20260505130000_SeedBackgroundImageUrls")]
    partial class SeedBackgroundImageUrls
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wutsup.Api.Models.DiscoveryItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<int>("NavigationNodeId")
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Wutsup.Api.Models.DiscoveryItem", b =>
                {
                    b.HasOne("Wutsup.Api.Models.NavigationNode", "NavigationNode")
                        .WithMany()
                        .HasForeignKey("NavigationNodeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_discovery_items_navigation_node_id");

                    b.Navigation("NavigationNode");
                });
